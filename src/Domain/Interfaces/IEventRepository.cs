...
public interface IEventRepository : IRepository<Event>
{
    ...
    Task<IEnumerable<Event>> GetTodayEventsAsync(Guid userId);
    Task<IEnumerable<Event>> GetWeekEventsAsync(Guid userId);
    Task<IEnumerable<Event>> GetMonthEventsAsync(Guid userId);
